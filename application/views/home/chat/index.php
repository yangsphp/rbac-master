        ...
        <div class="sidestrip">
            ...
            <div class="sidestrip_icon">
                ...
                <a id="si_2" style="position: relative">
                    <span id="no-ok-friend" class="no-read" style="display: inline;left: 15px;top: -2px;">1</span>
                </a>
                <a id="si_3"></a>
            </div>
...
<button
        ...
        data-am-modal="{target: '#doc-modal-12', closeViaDimmer: 0, width: 400, height: 225}">
    Modal
</button>
...
<script type="text/javascript">
    ...
    function initEmotion() {
        let emotion = "";
        for (let i = 1; i < 105; i++) {
            emotion += `<li onclick="selectEmotion(this)" data-url="/static/chat/emotion/` + i + `.gif">
                <img style='width:24px;height:24px;' src='/static/chat/emotion/` + i + `.gif'>
            </li>`
        }
